...
impl DatasourceId {
    ...
    pub fn new_unique() -> Self {
        ...
        {
            return Self::unique_from_sysvar();
        }

        #[cfg(not(any(target_arch = "bpfel", target_arch = "bpfeb")))]
        {
    ...
    fn unique_from_sysvar() -> Self {
        ...
        let hash = hash(&seed);
        let encoded = bs58::encode(hash.to_bytes()).into_string();
        Self(encoded)
    }
